...
function About({}: Props) {
  return (
    ...
    >
      ...
      />
      <div className="space-y-3 px-0 md:px-10 max-h-[45%] md:max-h-[70%] overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-track-black scrollbar-thumb-[#f7ac0a]/80 ">
        <h4 className="font font-semibold text-center text-2xl">
          Here is a{" "}
          <span className="underline decoration-[#f7ac0a25]">little</span> about
          myself
        </h4>
        ...
        <p className="aboutParagraph">
          ...
          used to work with engineering and Some years later, while working with
          engineering, developing new projects for the electronic industry. It
        ...
        <p className="aboutParagraph">
          ...
          exitate to send me a message, I'm super nice to talk to! :D
        </p>
      </div>
    </motion.div>
  );
